...
public final class MediaMetadataCompat implements Parcelable {
    ...
    /* renamed from: d */
    static final C3827a<String, Integer> f29d;
    ...
    static {
        C3827a<String, Integer> aVar = new C3827a<>();
        f29d = aVar;
    ...
    MediaMetadataCompat(Parcel parcel) {
        this.f30b = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }

    /* renamed from: a */
    public static MediaMetadataCompat m23a(Object obj) {
        if (obj == null || Build.VERSION.SDK_INT < 21) {
            return null;
        }
        Parcel obtain = Parcel.obtain();
        C0016f.m55a(obj, obtain, 0);
        obtain.setDataPosition(0);
        MediaMetadataCompat createFromParcel = CREATOR.createFromParcel(obtain);
        obtain.recycle();
        createFromParcel.f31c = obj;
